(function ($) {
    ...
    DataTable.prototype = {
        ...
        **/
        ...
        /**
         * Updates many elements in the data array. This is more efficient than calling updateRow multiple times
         * @param rowData {Array} of the form [[id, data]]
         */
            ...
            if ($.isPlainObject(args[0])) {
                ...
                switch (args[0]) {
                    ...
                    case 'update':
                        ...
                        break;
                    case 'updateAll':
                        this.datatable.updateRows(args[1]);
                        break;
                    case 'delete':
